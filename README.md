...
2. **Edit `go.mod`** 
   Change the module path from: `module github.com/RasmusKebert/d7024e-tutorial` to your new project path.
...
- `internal/cli/talk.go`  
  Line 4:
  ```go
  "github.com/RasmusKebert/d7024e-tutorial/pkg/helloworld"
  ```
...
Replace each instance of `github.com/RasmusKebert/d7024e-tutorial` with your new module name.
...
Published releases will appear here: [GitHub Releases - RasmusKebert/d7024e-tutorial](https://github.com/RasmusKebert/d7024e-tutorial/releases)

The Docker workflow will automatically build and publish a Docker image on GitHub.  
See this page: [GitHub Packages - RasmusKebert/d7024e-tutorial](https://github.com/RasmusKebert/d7024e-tutorial/pkgs/container/RasmusKebert/d7024e-tutorial)
